...
public class T1_xpath_cssSelector_practice {
    public static void main(String[] args) {
        ...
        //WebElement retrievePwBtn = driver.findElement(By.xpath("//i[@class='icon-2x icon-signin']"));
       // WebElement retrievePwBtn = driver.findElement(By.xpath("//i[text()='Retrieve password']"));
        WebElement retrievePwBtn = driver.findElement(By.xpath("//button[@id='form_submit']"));

        //f. “Powered by Cydeo text
      //  WebElement poweredByCydeoTxt = driver.findElement(By.xpath("//div[@style='text-align: center;']"));
        WebElement poweredByCydeoTxt = driver.findElement(By.xpath("//div[contains(@style,'center')]"));
        ...
        System.out.println("retrievePwBtn.isDisplayed() = " + retrievePwBtn.isDisplayed());
